...
| Hindi edition | `@qubit/hindi` | 5177 | 4177 |
...
| `packages/qa` hindi suite | 4177 | `packages/qa/playwright.config.ts` |
...
Adding an app: take the next free pair (5178/4178) and add a row here.
